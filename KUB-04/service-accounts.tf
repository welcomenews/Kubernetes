# файл для настройки сервисных аккаунтов. Мы создаем два аккаунта — один нужен
# для управления группами узлов — для их автоматического масштабирования,
# а второй — для авторизации в container registry — чтобы мы могли скачивать и
# заливать наши образы в yandex container registry.
